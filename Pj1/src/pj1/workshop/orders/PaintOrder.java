...
public abstract class PaintOrder {
    ...
    public int getPiezasTotal() {
        return piezasTotal;
    }

    public void setPiezasTotal(int piezasTotal) {
     ...
     */
    protected PaintOrder(int number, String plate, int total, double time, int piezasTotal, String vehiculo) {
        this.number = number;
        this.plate = plate;
        this.total = total;
        this.time = time;
